...
import json
import os
from modules import KhunSangkeetE_Admin, KhunSangkeetE_User, FunctionForModule, checkRequiredFile, KhunSangkeetE_Admin_SubSystem
...
print("""\x1b[38;5;27m
   ...
   _____                   _  __         _   ______  __  __          _     ____  
  / ____|                 | |/ /        | | |  ____|/ _|/ _|        | |   |  _ \ 
 | (___   __ _ _ __   __ _| ' / ___  ___| |_| |__  | |_| |_ ___  ___| |_  | |_) |
  \___ \ / _` | '_ \ / _` |  < / _ \/ _ \ __|  __| |  _|  _/ _ \/ __| __| |  _ < 
  ____) | (_| | | | | (_| | . \  __/  __/ |_| |____| | | ||  __/ (__| |_  | |_) |
 |_____/ \__,_|_| |_|\__, |_|\_\___|\___|\__|______|_| |_| \___|\___|\__| |____/ 
                      __/ |                                                      
                     |___/                                         สังคีตเอฟเฟกต์  บี version

  GitHub : https://github.com/BoszGTec                         ===========================
\x1b[0m""")

if checkRequiredFile.checkSys():
    if checkRequiredFile.limit_option:
    ...
    KhunSangkeetE_Admin.limit_option = checkRequiredFile.limit_option
